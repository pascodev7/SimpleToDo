package com.pascaljeanty.simpletodo
...
//            Log.i("Pascal", "user clicked on button")
//        }
        ...
        // Set up the button and input field, so that yhe user can enter a task  and add it to the list
